...
const Footer = () => {
  return (
    <div className="bg-base-200">
      <footer className="footer container mx-auto text-base-content p-10">
        <aside>
          ...
          <p>
            ...
            <br />
            <span className="pl-2">Providing reliable tech since 1992</span>
          </p>
        </aside>
        <nav>
      ...
      <footer className="footer container mx-auto text-black    border-t-2 border-[#0000002d] items-center p-4">
        <aside className="grid-flow-col items-center">
          <p>
            Copyright © ${new Date().getFullYear()} -{" "}
            <span className="font-semibold">Waliur Rafiq Sami</span>
          </p>
        </aside>
